...
I wanted to do something different on this blog and go through something that's less of my side-project, and more of my project project, i.e. PET pharmacokinetic modelling. In Part 2, I'll cover basic use of the *kinfitr* package and iteration.
...
**Note:** Most linearised models have, as either a required or optional parameter, a t\* value. I'll cover this in another post. But, for now, we don't need to worry about this as MRTM1 and MRTM2 require a t\* value only in the case of not following 1-tissue compartment dynamics, and this data was specifically simulated to follow this. But I'll use a value for some of the other models, but read the other post to understand this.
...
The first, complicated aspect of working with data for which we must use the arterial plasma as a reference is that this data is collected through a parallel data collection, and is stored separately. I've written up another post about how to do this. But, for expedience, here I'll just interpolate some data which was already processed.  Let's look at how the data looks, and what's in the processed blood data for a random subject.
